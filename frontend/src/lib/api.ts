...
export const updatePropertyExpense = (propertyId: string, expenseId: string, data: Record<string, unknown>) => api.patch(`/properties/${propertyId}/expenses/${expenseId}`, data).then((r) => r.data.data);
